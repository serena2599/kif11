...
这篇文章从5个病人的全外显子组测序入手，想要得到之前未发现的、同时存在于这5个样本中的突变，但是没有找到这样的突变位点。作者降低要求，找到在3个样本中相同的3个新的突变，位于kif11基因上，这3个突变包括1一个无义突变，一个但碱基缺失突变和一个双碱基缺失突变。
作者对这九个MLCRD家系的kif11测序，鉴定出了7个kif11突变位点，包括3个移码突变，2个错义突变，2个剪切位点突变。
所以目前为止作者从14个MLCRD家系中一共鉴定出10个KIF11突变。
因为鉴定出这些突变位点的患者中有的并没有淋巴水肿，CDMMR与MLCRD可能有相同的等位突变，所以作者对CDMMR的6个家庭进行kif11测序，得到5个新的kif11突变位点，包括2个错义突变，一个无义突变（p.Arg387*）和另外两个突变。其中无义突变与之前得到的无义突变相同。
综上，**作者从15个家系27个个体中鉴定出了14个突变位点，其中4个错义突变都发生在保守序列区域，是我们实验中比较关心的位点**。
